...
def save_to_csv(asset_data_list, filename='my_fab_assets_library.csv'):
...
def save_to_xlsx(asset_data_list, filename='my_fab_assets_library.xlsx'):
...
if __name__ == "__main__":
    ...
    if my_assets:
        ...
        # 3. 保存为CSV文件 (适合数据存储和交换)
        # save_to_csv(my_assets)

        # 4. 保存为XLSX文件 (适合查看和编辑)
        save_to_xlsx(my_assets)
